...
export default function SignupPage(): React.JSX.Element {
    ...
    return (
        <>
            ...
            {!loading && !errorMsg && (
                <Container className="mt-[42px] flex h-auto w-full flex-col items-center justify-center gap-6 pb-[42px] sm:mt-0 sm:h-full sm:max-w-2xl">
            ...
            {!loading && errorMsg && (
                <Container className="mx-auto mt-28 flex w-full max-w-xl flex-col items-center justify-center gap-2 rounded-2xl border border-white border-opacity-20 bg-[rgba(0,124,91,0.20)] px-4 py-6 text-center text-white backdrop-blur-md sm:px-[40px] sm:py-10">
