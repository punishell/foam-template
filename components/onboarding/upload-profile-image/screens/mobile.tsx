    ...
    return (
        <div className="max-h-auto relative flex w-full shrink-0 flex-col items-center gap-4 sm:hidden">
            <div className="relative flex w-full items-center justify-between">
                ...
                <Button
                    className="!mx-0 !px-0 !text-lg !font-normal !text-white"
                    type="button"
                    size="lg"
                    onClick={() => {
            ...
            <div className="relative flex h-[539px] w-full shrink-0 flex-col items-center justify-center gap-4 rounded-2xl bg-white sm:hidden">
                <FloatingAvatars />
