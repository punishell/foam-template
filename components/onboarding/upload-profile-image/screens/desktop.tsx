...
export function DesktopUploadProfileImage({
    ...
    return (
        <div className="relative hidden w-full shrink-0 flex-col items-center gap-4 sm:flex">
            <FloatingAvatars />

            <div className="relative w-full">
                <Button
                    className="!absolute -top-4 left-0 w-[148px] !border-primary !text-lg !font-normal text-primary hover:bg-lime-50 hover:!text-primary"
                    type="button"
                    size="sm"
