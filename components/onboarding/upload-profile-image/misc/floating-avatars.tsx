    ...
    return (
        <div className="w-full">
            ...
            <div className="block sm:hidden">
                <div className="absolute left-[50%] top-[3%] h-10 w-10 -translate-x-1/2 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-3.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute left-[10%] top-[18%] h-10 w-10 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-1.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute left-[0%] top-[50%] h-10 w-10 -translate-y-1/2 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-2.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute bottom-[18%] left-[10%] h-10 w-10 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-3.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute right-[10%] top-[18%] h-10 w-10 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-4.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute right-[0%] top-[50%] h-10 w-10 -translate-y-1/2 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-5.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute bottom-[18%] right-[10%] h-10 w-10 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-6.png"
                        alt=""
                        height={85}
                ...
                <div className="absolute bottom-[3%] left-[50%] h-10 w-10 -translate-x-1/2 rounded-full opacity-60">
                    <Image
                        src="/images/onboarding-3.png"
                        alt=""
                        height={85}
