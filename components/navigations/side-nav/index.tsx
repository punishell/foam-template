...
export const Sidebar = (): ReactElement => {
    ...
    return (
        <div className="px hidden h-screen shrink-0 basis-[240px] flex-col gap-6 overflow-hidden bg-sidebar-gradient px-6 pb-4 pt-6 text-white sm:flex 2xl:basis-[280px]">
