...
export function ReferralSideModal({
    ...
    return (
        <div
            className={`fixed top-16 z-50 flex h-[calc(100vh-129px)] w-full flex-col overflow-y-scroll bg-white transition-all duration-300 ease-in-out ${isOpen ? "right-0" : "-right-full"}`}
        >
            <div className="flex flex-row items-center gap-4 bg-primary-gradient p-6 text-2xl font-bold text-white">
                <Button
                    className="m-0 p-0"
                    onClick={() => {
                        onOpenChange(false);
            ...
            {!isSentEmail ? (
                <div className="flex max-w-full flex-col gap-2 px-5 py-6">
                    ...
                    <div className="my-4 w-full rounded-2xl border border-primary-darker bg-primary-brighter p-4">
                        ...
                        >
                            <div className="w-full max-w-[380px] rounded-2xl border bg-input-bg p-1">
                                <Controller
                                    name="emails"
                                    ...
                                    render={({
                                        ...
                                        <TagInput2
                                            tags={value}
                                            setTags={onChange}
                                            className="w-full items-start border border-none"
