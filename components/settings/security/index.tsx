    ...
    <div className='flex flex-row relative gap-6 h-full grow overflow-auto pb-4'>
      <div className='flex flex-col w-1/4 h-fit bg-white rounded-lg'>
        <div className='flex flex-col gap-4 p-4'>
          ...
          <Input {...form.register('newPassword')} className="w-1/2 !bg-[#FCFCFD] !border-[#E8E8E8]" placeholder="enter new password" label='New Password' />
          ...
          <Input {...form.register('confirmNewPassword')} className="w-1/2 !bg-[#FCFCFD] !border-[#E8E8E8]" placeholder="re-enter new password" label='Confirm New Password' />
