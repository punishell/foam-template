...
const LoginForm = (): React.JSX.Element => {
    ...
    return (
        <form
            ...
            className="mx-auto flex w-full flex-col items-center gap-6 rounded-2xl border border-white border-opacity-20 bg-primary bg-opacity-20 p-4 backdrop-blur-md sm:max-w-[600px] sm:px-[40px] sm:py-10"
        >
