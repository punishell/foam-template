...
const SignupVerificationForm = (): React.JSX.Element => {
    ...
    return (
        <form
            className="relative z-[100] mx-auto flex w-full flex-col items-center gap-6 rounded-2xl border border-white border-opacity-20 bg-[rgba(0,124,91,0.20)] p-4 backdrop-blur-md sm:max-w-[600px] sm:px-[40px] sm:py-10"
                        ...
                        return (
                            <ReactOTPInput
                                ...
                                renderInput={(props) => (
                                    <input
                                        {...props}
                                        className="h-[40px] w-[40px] !select-none rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-primary sm:h-[46px] sm:w-[46px]"
                                        style={{
                                            borderRadius: "4px",
