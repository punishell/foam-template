...
const JobDeliverables = ({ form, isEdit }: JobDeliverablesProps): ReactElement => {
    return (
        <div className="flex flex-col gap-2">
            <h3 className="text-lg font-medium text-black">
                Deliverables{" "}
                {!isEdit && (
                    <span className="ml-4 text-sm font-thin text-body">You can create up to five deliverables</span>
                )}
            </h3>
