...
export const SecondPlace = ({ _id, name, score, avatar }: LeaderBoardItemProps): React.ReactElement => {
	...
	return tab ? (
		...
		<div className="relative rounded-2xl border bg-mobile-l2 border-[#BBD2C5] h-[67px] flex items-center justify-center">
