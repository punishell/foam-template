...
export const PublicJobCreatedFeed = ({
    ...
    return tab ? (
        <div className="relative z-10 hidden w-full gap-4 overflow-hidden rounded-2xl border border-[#CDCFD0] bg-[#F9F9F9] px-4 pl-2 sm:flex">
            <AfroProfile
                score={creator.score}
                src={creator.avatar}
                size="lg"
        ...
        <Link
            href={`/jobs/${jobId}`}
            className="relative z-10 flex w-full flex-col gap-4 overflow-hidden border-b border-[#CDCFD0] bg-[#F9F9F9] px-[21px] py-4 sm:hidden"
        >
