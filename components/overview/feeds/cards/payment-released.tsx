...
export const PaymentReleased = ({
    ...
    return (
        <>
            <div className="relative z-10 hidden w-full gap-4 overflow-hidden rounded-2xl border border-[#7DDE86] bg-[#FBFFFA] px-4 pl-2 sm:flex">
                <AfroProfile
            ...
            <Link
                href="/wallet"
                className="relative z-10 flex w-full gap-4 overflow-hidden border-b border-[#7DDE86] bg-[#FBFFFA] px-[21px] py-4 sm:hidden"
            >
                <div className="flex w-full flex-col gap-4">
                    <div className="flex w-full items-center justify-between">
                        <h3 className="text-base font-medium leading-normal tracking-tight text-body">
                            {isCreator
                                ? "Job Completed"
                                : "💰 Payment Released"}
                        </h3>
