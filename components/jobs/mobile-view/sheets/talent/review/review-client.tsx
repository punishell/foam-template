    ...
    return (
        <>
            ...
            <div className="flex h-[calc(100%-70px)] flex-col gap-4 p-4">
                ...
                <h3 className="text-lg leading-[27px] tracking-wide">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-base font-bold leading-normal tracking-wide text-blue-950">{`${creator?.firstName} ${creator?.lastName}`}</span>
                            <span className="text-xs capitalize leading-[18px] tracking-wide text-blue-950">
