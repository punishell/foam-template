        ...
        <div className="flex flex-col">
            ...
            >
                ...
                <div className="flex flex-col gap-2 px-2">
                    <span className="text-sm text-body">Due Date</span>
                    <span className="text-base text-black">
                ...
                <div className="flex flex-col gap-2 px-2">
                    <span className="text-sm text-body">Price</span>
                ...
                <div className="flex flex-col gap-2 pl-2">
                    ...
                    <p
                        className={`flex items-center justify-center rounded-full p-1 text-center text-[10.50px] leading-none tracking-wide text-white ${rubik.className}`}
                        style={{
                            borderColor:
