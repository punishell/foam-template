...
const TalentPrivateJobCtas: React.FC<TalentPrivateJobCtasProps> = ({
	inviteId,
	hasBeenInvited,
...
const TalentJobApplyModal: React.FC<TalentJobApplyModalProps> = ({
	jobId,
	jobCreator,
}) => {
...
export const TalentJobDetails: React.FC<TalentJobDetailsProps> = ({
	job,
	userId,
}) => {
